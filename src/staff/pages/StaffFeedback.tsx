...
const mockTickets = [
  { id: "T-001", user: "+77001234567", subject: "Вопрос по заказу", status: "open", date: "2024-02-23" },
  { id: "T-002", user: "+77009876543", subject: "Проблема с доставкой", status: "in_progress", date: "2024-02-22" },
  { id: "T-003", user: "+77005555555", subject: "Вопрос по товару", status: "resolved", date: "2024-02-20" },
];
  ...
  return (
    <StaffLayout>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Обращения в поддержку</h1>
