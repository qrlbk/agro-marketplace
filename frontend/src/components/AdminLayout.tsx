...
import { getAdminNavItems } from "../backoffice/navConfig";

const basePath = "/admin";
const nav = getAdminNavItems().map((item) => ({
...
export function AdminLayout() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 min-h-0">
      <aside className="lg:w-56 shrink-0 flex flex-row lg:flex-col gap-2 lg:gap-1 border-b lg:border-b-0 lg:border-r border-gray-200 pb-3 lg:pb-0 bg-white">
